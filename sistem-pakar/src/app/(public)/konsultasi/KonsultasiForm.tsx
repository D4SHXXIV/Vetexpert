...
export default function KonsultasiForm({ symptoms }: KonsultasiFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Data berhasil disubmit! Cek console untuk detail.");
    // In the future, send this data to the diagnosis service API
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="pt-6">
        <button
          type="submit"
          className="w-full bg-green-600 hover:bg-green-700 active:bg-green-800 text-white font-bold py-3.5 px-4 rounded-xl shadow-md transition-all flex justify-center items-center gap-2"
        >
